...
import { Parser, parsePosition, parseAliasReplacement } from './parsing'

import { StatusCode, Interprater, lastCommand, snipes, purgeSnipe, createAliases, aliases, runCmd, handleSending, CommandCategory, commands} from './common_to_commands'
...
const extra_commands: { [command: string]: Command | CommandV2 } = {
